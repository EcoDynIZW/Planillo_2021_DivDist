...
filename = file.path(Model_wd, "model_pois_spiders2_abu_3sites.Rdata")
load(file = filename)
...
# save results
write.csv(res.df , paste0(Output_wd, "/Predict_fullmap_spiders2.csv"))

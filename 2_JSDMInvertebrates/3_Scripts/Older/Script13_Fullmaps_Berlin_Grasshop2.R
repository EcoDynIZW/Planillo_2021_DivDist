...
## Prediction map for grasshoppers2 
## Used a grid of 500m

# Model: grasshop2
# without species only in 1 or 2 sites #

# Env predictors: ~imperv.100m + open.green.500m
...
filename = file.path(Model_wd, "model_pois_grasshop2_abu_3sites.Rdata")
load(file = filename)
...
# save results
write.csv(res.df , paste0(Output_wd, "/Predict_fullmap_grasshop2.csv"), row.names = F)
